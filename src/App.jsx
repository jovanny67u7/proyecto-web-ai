...
// Navbar completo. Vive dentro de <Router> (necesita useLocation) para poder
// detectar cuándo el usuario está en /dashboard y ocultar ahí el menú de
// marketing (Servicios/Nosotros/Clientes/Opiniones/búsqueda) — dentro del
// panel de administración ese menú no aplica y solo generaba ruido visual.
function Navbar({ isSummerPromo }) {
  ...
  return (
    <nav
      ...
      style={{
        ...navStyles,
        top: isSummerPromo ? '3.5rem' : '1.5rem',
        ...(enDashboard ? { justifyContent: 'space-between' } : {}),
      }}
    >
...
function App() {
  ...
  return (
    <Router>
      ...
      <Navbar isSummerPromo={isSummerPromo} />
      ...
      <footer style={footerStyle}>
        <div className="container" style={footerInnerStyle}>
          <div style={{ flex: 1, minWidth: '220px' }}>
            <h4 style={{ marginBottom: '0.6rem' }}>asídesimple <span style={aiTextStyles}>AI</span></h4>
            <p style={{ color: 'var(--text-muted)', fontSize: '0.8rem', marginBottom: '0.85rem' }}>
              Innovación y desarrollo tecnológico desde Querétaro, México.
            </p>
          ...
          <div style={{ flex: 1, minWidth: '180px' }}>
            <h4 style={{ marginBottom: '0.6rem' }}>Marco Legal</h4>
          ...
          <div style={{ flex: 1, minWidth: '220px' }}>
            <h4 style={{ marginBottom: '0.6rem' }}>Datos de Contacto</h4>
        ...
        <div style={{ textAlign: 'center', color: 'var(--text-muted)', fontSize: '0.75rem', marginTop: '1.75rem' }}>
...
const footerStyle = { borderTop: '0.5px solid var(--border)', padding: '2.5rem 2rem 1.5rem', background: 'var(--brand-dark)' };
